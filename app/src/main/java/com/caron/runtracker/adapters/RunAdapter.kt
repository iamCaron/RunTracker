package com.caron.runtracker.adapters
...
class RunAdapter(val itemClickListener: OnItemClickListener): RecyclerView.Adapter<RunAdapter.RunViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RunViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            val caloriesBurned= Utility.getFormattedCalories(run.caloriesBurned.toFloat())
            tvCalories.text=caloriesBurned

            this.setOnClickListener { itemClickListener.onItemClicked(run) }
        }
    }
